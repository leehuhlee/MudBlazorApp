using MudBlazorApp.Shared.Extensions;
    ...
    public class UploadService : IUploadService
    {
        public string UploadAsync(UploadRequest request)
        {
            ...
            if (streamData.Length > 0)
            {
                ...
                var goalDir = Path.Combine(Directory.GetParent(currentDir).FullName, "Client\\wwwroot", folderName);
                var pathToSave = Path.Combine(goalDir);
